...
cmd:option('-output_prefix','_eval_out','prefix for which datset is used')
...
-------------------------------------------------------------------------------
local loader = DataLoader{clip_info_file=opt.clip_info_file, 
		qa_label_file=opt.qa_label_file, fix_num_frame=true, 
		data_path=opt.img_root}
