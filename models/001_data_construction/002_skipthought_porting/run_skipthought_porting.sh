...
if [ ! -d ${path} ]; then
   ...
   wget cvlab.postech.ac.kr/~jonghwan/research/MarioQA/skipthought/paper_version.tar
...
echo '====================================================================='
th 004_save_params_in_torch_file.lua \
	-utable_path videoqa_utable_${dt}.npy \
